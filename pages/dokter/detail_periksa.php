            ...
            <table class="w-full table-fixed border border-yellow-500">
                <thead class="">
                    <tr>
                        ...
                        <th class="w-[20%] border border-slate-500 py-3">Hari Periksa</th>
                        <th class="w-[25%] border border-slate-500 py-3">Nama Pasien</th>
                        <th class="w-[30%] border border-slate-500 py-3">Nama Dokter</th>
                        <th class="w-[30%] border border-slate-500 py-3">Keluhan</th>
                        <th class="w-[30%] border border-slate-500 py-3">Catatan</th>
                        <th class="w-[30%] border border-slate-500 py-3">Obat</th>
                        <th class="w-[30%] border border-slate-500 py-3">Biaya Periksa</th>
                    </tr>
                </thead>
